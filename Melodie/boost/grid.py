...
class Grid:
    ...
    def init_grid(self):
        self._spots = [[new(self._spot_cls(self._convert_to_1d(x, y), self, x, y))
    ...
    def rand_move_agent(self, agent: GridAgent, category, range_x, range_y):
        ...
        dx = math.floor((random.random()*(2*range_x+1))) - range_x
        dy = math.floor((random.random()*(2*range_y+1))) - range_y
